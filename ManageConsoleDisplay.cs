    ...
    internal static class ManageConsoleDisplay
    {
        ...
        private static Panel CurrentWeatherDisplayPanel(CurrentWeather currentWeather)
        {
            ...
            if (currentWeather != null)
            {
                ...
                markup.Add(new Markup($"[bold green]Visibility: [/]{String.Format("{0:0.0000}", Program.MetersToMiles(currentWeather.Visibility))} miles"));
                ...
                markup.Add(new Markup($"[bold green]Wind Cardinal Direction: [/]{Program.WindDegToDir(currentWeather.Wind.deg)}"));
                ...
                {
                    markup.Add(new Markup($"[bold green]Rain Volume Last Hour: [/]{String.Format("{0:0.0000}", Program.mmToInch(currentWeather.Rain.hr1))} inches"));
                    markup.Add(new Markup($"[bold green]Rain Volume Last 3 Hours: [/]{String.Format("{0:0.0000}", Program.mmToInch(currentWeather.Rain.hr3))} inches"));
                }
                if (currentWeather.Snow != null)
                {
                    markup.Add(new Markup($"[bold green]Snow Volume Last Hour: [/]{String.Format("{0:0.0000}", Program.mmToInch(currentWeather.Snow.hr1))} inches"));
                    markup.Add(new Markup($"[bold green]Snow Volume Last 3 Hours: [/]{String.Format("{0:0.0000}", Program.mmToInch(currentWeather.Snow.hr3))} inches"));
                }
                ...
                markup.Add(new Markup($"[bold green]Time Of Data Calculation: [/]{Program.UnixTimeStampToDateTime(currentWeather.UnixTimeStamp, true)}"));
                markup.Add(new Markup($"[bold green]Sunrise: [/]{Program.UnixTimeStampToDateTime(currentWeather.SunRiseSetUnixStamp.sunrise, true)}"));
                markup.Add(new Markup($"[bold green]Sunset: [/]{Program.UnixTimeStampToDateTime(currentWeather.SunRiseSetUnixStamp.sunset, true)}"));
        ...
        private static List<Panel> ForecastWeatherDisplayPanels(ForecastWeather forecastWeather)
        {
            ...
            foreach (ForecastRecord forecastRecord in forecastList)
            {
                ...
                markup.Add(new Markup($"[bold green]Time Of Data Forecasted: [/][bold blue]{Program.UnixTimeStampToDateTime(forecastRecord.TimeDataForecastedUNIX_UTC, false)}[/]"));
                ...
                {
                    markup.Add(new Markup($"[bold green]Rain Volume Last 3 Hours: [/][bold blue]{String.Format("{0:0.0000}", Program.mmToInch(forecastRecord.Rain.hr3))} inches[/]"));
                }
                if (forecastRecord.Snow != null)
                {
                    markup.Add(new Markup($"[bold green]Snow Volume Last 3 Hours: [/][bold blue]{String.Format("{0:0.0000}", Program.mmToInch(forecastRecord.Snow.hr3))} inches[/]"));
                }
                ...
                markup.Add(new Markup($"[bold green]Visibility: [/]{String.Format("{0:0.0000}", Program.MetersToMiles(forecastRecord.Visibility))} miles"));
                ...
                markup.Add(new Markup($"[bold green]Wind Cardinal Direction: [/]{Program.WindDegToDir(forecastRecord.Wind.deg)}"));
                ...
                markup.Add(new Markup($"[bold green]Sunrise: [/]{Program.UnixTimeStampToDateTime(forecastWeather.City.sunrise, true)}"));
                markup.Add(new Markup($"[bold green]Sunset: [/]{Program.UnixTimeStampToDateTime(forecastWeather.City.sunset, true)}"));

                Rows forecastRows = new Rows(markup);
                Panel forecastPanel = new Panel(forecastRows);
                forecastPanel.Header = new PanelHeader($"Forecast Weather: [bold blue]{Program.UnixTimeStampToDateTime(forecastRecord.TimeDataForecastedUNIX_UTC, false).DayOfWeek}[/]");
